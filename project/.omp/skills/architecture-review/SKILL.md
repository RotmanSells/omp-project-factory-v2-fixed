...
description: "Review architecture for boundary failures, hidden cost and unsafe assumptions."
---
# Purpose
Review architecture for boundary failures, hidden cost and unsafe assumptions.
